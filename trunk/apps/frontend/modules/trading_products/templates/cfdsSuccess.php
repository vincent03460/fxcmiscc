...
<p><?php echo __("Contracts for Difference is an over-the-counter financial agreement to exchange the difference between the opening and closing value of a contract at its close. Rather than buying or selling the actual instrument on which your contract is based, you simply place a trade with a CFD provider like FX-CMISC. The price of your CFD will correspond with current price of the actual instrument on which your contract is based.") ?></p>
<p><strong><?php echo __("Leverage your Investment Potential") ?></strong></p>
<p><?php echo __("CFDs are traded on leverage, so you can increase your exposure to an underlying asset with the same initial investment. To open a CFD trade, you need to deposit only a small percentage of the total trade value. FX-CMISC offers the option of 100 times leverage on your invested capital.") ?></p>
...
<p><strong><?php echo __("Why Trade CFDs with FX-CMISC?") ?></strong></p>
<p><?php echo __("CFDs are an increasingly popular way to trade, thanks to their flexibility and accessibility to global markets. FX-CMISC provides you with the most popular CFDs.") ?></p>
